// مجموعه آیکون‌های SVG داشبورد بارینه
...
export const ArrowBack = ({ size = 22 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const TrendIcon = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <path d="M3 17l5-5 3.5 3.5L21 7" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M16 7h5v5" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

export const BoxIcon = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <path d="M12 2.5l8 4.2v10.6L12 21.5l-8-4.2V6.7l8-4.2z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" />
    <path d="M4 7l8 4.2L20 7M12 11.2V21.5" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" />
  </svg>
);

export const MedalIcon = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <circle cx="12" cy="9" r="5.5" stroke="currentColor" strokeWidth="1.8" />
    <path d="M9 13.5L7.5 21l4.5-2.4L16.5 21 15 13.5" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" />
    <path d="M12 6.6l.9 1.8 2 .3-1.45 1.4.35 2L12 11.9l-1.8.95.35-2L9.1 8.7l2-.3.9-1.8z" fill="currentColor" />
  </svg>
);

export const TruckIcon = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <path d="M3 6.5h10v9H3z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" />
    <path d="M13 9.5h4l3 3v3h-7z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" />
...
export const RouteIcon = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    ...
    <circle cx="18" cy="18" r="2.4" stroke="currentColor" strokeWidth="1.9" />
    <path d="M8.4 6H15a3 3 0 013 3v0a3 3 0 01-3 3H9a3 3 0 00-3 3v0" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" />
  </svg>
);
...
export const ChartMiniIcon = ({ size = 16 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export const ChatIcon = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <path d="M4 5h16v11H8l-4 3.5V5z" stroke="currentColor" strokeWidth="1.9" strokeLinejoin="round" />
    <path d="M8.5 10.5h.01M12 10.5h.01M15.5 10.5h.01" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" />
  </svg>
);
...
export const PackageIcon = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <path d="M12 2.5l8 4.2v10.6L12 21.5l-8-4.2V6.7l8-4.2z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" />
    <path d="M4 7l8 4.2L20 7M12 11.2V21.5M8 4.6l8 4.2" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" />
  </svg>
);

export const ClipboardIcon = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <path d="M8 4h8v3H8z" stroke="currentColor" strokeWidth="1.9" strokeLinejoin="round" />
    <path d="M6 5.5H5v15h14v-15h-1" stroke="currentColor" strokeWidth="1.9" strokeLinejoin="round" />
    <path d="M8.5 13l1.5 1.5 3-3.5" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

export const AddSquareIcon = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
